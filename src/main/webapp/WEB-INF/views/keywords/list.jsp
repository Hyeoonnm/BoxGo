...
<div class="container">
    ...
    <table class="table">
        ...
        <c:forEach var="keywords" items="${keywords}" varStatus="status">
            <tr>
                <th scope="row">${keywords.keywordsId}</th>
                <td>${keywords.keywordsName}</td>
                <td>
                    <a href="update/${keywords.keywordsDomainId}" class="btn btn-sm btn-secondary ms-1">수정</a>
                    <a href="delete/${keywords.keywordsDomainId}" class="btn btn-sm btn-danger">삭제</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="d-flex justify-content-center">
        ...
        <a href="../../domain/list" class="btn btn-secondary ms-1 me-3">뒤로</a>
    </div>
</div>
